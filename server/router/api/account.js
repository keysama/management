...
router.use('/saveChange',account.saveChange);
router.use('/saveChange',function(req,res){
    res.json({res: 1})
});

router.use('/changePass',account.changePass);
router.use('/changePass',function(req,res){
    res.json({res: 1})
});
