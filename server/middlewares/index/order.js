...
//添加order的附件
        ...
        let sql4=`INSERT INTO news (pid,text,time) VALUES (${orderInfo.project},'${req.session.user.nickname+"创建了订单:"+orderInfo.name}','${Date.now()}')`;
...
//获取提料单列表
    ...
    async delete(req,res,next){
        ...
        let sql4=`INSERT INTO news (pid,text,time) VALUES (${req.body.project},'${req.session.user.nickname+"创建了订单:"+orderInfo.name}','${Date.now()}')`;
        let res4=await myPro(sql4);
